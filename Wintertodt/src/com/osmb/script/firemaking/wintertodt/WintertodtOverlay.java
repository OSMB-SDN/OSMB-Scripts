...
public class WintertodtOverlay extends OverlayBoundary {
    ...
    public List<OverlayValueFinder> applyValueFinders() {
        ...
        OverlayValueFinder<Map<Brazier, BrazierStatus>> brazierStatusFinder = new OverlayValueFinder<>(BRAZIER_STATUS, overlayBounds -> updateBrazierStatusMap(overlayBounds));
