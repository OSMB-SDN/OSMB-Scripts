...
public enum NPC {
    ...
    WHITE_MAN(Dock.PORT_PHASMATYS, Dock.SHIPYARD, Dock.PORT_KHAZARD, Dock.MOS_LE_HARMLESS),
    BLACK_MAN(Dock.BRIMHAVEN ,Dock.PORT_TYRAS),
    DARK_PINK_YELLOW_WOMAN(Dock.SHIPYARD, Dock.PORT_KHAZARD, Dock.PORT_TYRAS),
    BURGUNDY_WHITE_WOMAN(Dock.PORT_PHASMATYS, Dock.MUSA_POINT, Dock.MOS_LE_HARMLESS);
