...
public class Constants {
    ...
    public static final Set<Integer> ITEM_IDS_TO_RECOGNISE = new HashSet<>(Set.of(ItemID.ICE_GLOVES, ItemID.BUCKET_OF_WATER, ItemID.COINS_995, ItemID.COAL_BAG, ItemID.OPEN_COAL_BAG, ItemID.GOLDSMITH_GAUNTLETS));
    public static final Set<Integer> ITEMS_TO_NOT_DEPOSIT = new HashSet<>(Set.of(ItemID.BUCKET_OF_WATER, ItemID.ICE_GLOVES, ItemID.COAL_BAG, ItemID.OPEN_COAL_BAG));
    ...
    public static final SearchablePixel DEFAULT_HIGHLIGHT_PIXEL = new SearchablePixel(-14286849, new SingleThresholdComparator(5), ColorModel.RGB);
